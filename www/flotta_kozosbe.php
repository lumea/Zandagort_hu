...
if ($aux2['tulaj']!=$uid) kilep($lang[$lang_lang]['kisphpk']['Nem a tied a flotta.']);

mysql_query('update flottak set kozos=1 where id='.$_REQUEST['flotta_id']) or hiba(__FILE__,__LINE__,mysql_error());
