...
*/        
    ...
    this.updateScrollBar = function(len) {
      if (self.ishwscroll) {
        self.rail.css({height:self.win.innerHeight()-2*self.opt.railpaddingv2});
      } else {
...
//        var brd = (self.win.outerWidth() - self.win.innerWidth());
		...
		pos.top+=self.opt.railpaddingv2;
        
        self.rail.css({top:pos.top,left:pos.left,height:((len)?len.h:self.win.innerHeight())-2*self.opt.railpaddingv2});
...
//
    ...
    this.onResize = function(e,page) {
      ...
      self.scrollvaluemax = self.view.h-self.cursorheight-self.cursor.hborder-2*self.opt.railpaddingv2;
