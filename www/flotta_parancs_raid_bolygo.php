...
if ($aux['tulaj_szov']==$flotta['tulaj_szov']) kilep($lang[$lang_lang]['kisphpk']['Saját és szövetséges bolygó ellen nem portyázhatsz.']);

mysql_query('update flottak set bolygo=0,statusz='.STATUSZ_RAID_BOLYGORA.',cel_bolygo='.$aux['id'].' where id='.$_REQUEST['flotta_id']) or hiba(__FILE__,__LINE__,mysql_error());
