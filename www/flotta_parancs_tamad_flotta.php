...
mysql_query('update flottak set bolygo=0,statusz='.STATUSZ_TAMAD_FLOTTARA.',cel_flotta='.$_REQUEST['flotta2_id'].' where id='.$_REQUEST['flotta_id']) or hiba(__FILE__,__LINE__,mysql_error());
