...
if ($_REQUEST['nev']=='') $_REQUEST['nev']='F'.$_REQUEST['flotta_id'];

mysql_query('update flottak set nev="'.mysql_real_escape_string($_REQUEST['nev']).'" where id='.$_REQUEST['flotta_id']) or hiba(__FILE__,__LINE__,mysql_error());
