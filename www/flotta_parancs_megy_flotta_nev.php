...
mysql_query('update flottak set bolygo=0,statusz='.STATUSZ_MEGY_FLOTTAHOZ.',cel_flotta='.$aux['id'].' where id='.$_REQUEST['flotta_id']) or hiba(__FILE__,__LINE__,mysql_error());
